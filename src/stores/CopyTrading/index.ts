...
const copyTradingStore: TCopyTradingStore = {
  ...
  openPositionLeverageMax: 50,
  openPositionMarginModeRadios: [
    { id: '', i18n: 'common.followTargetMargin', label: 'Follow target', value: 3 },
    { id: '', i18n: 'common.crossMargin', label: 'Cross', value: 2 },
    { id: '', i18n: 'common.isolatedMargin', label: 'Isolated', value: 1 },
  ],
  openPositionBuyModelRadios: [
    { id: '', i18n: 'common.assetProportional', label: 'Asset Proportional', value: 1 },
    { id: '', i18n: 'common.positionProportional', label: 'Position Proportional', value: 2 },
    { id: '', i18n: 'common.fixedValue', label: 'Fixed Value', value: 3 },
  ],
